...
export const BIG: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
    '0x4416AC96BEBDD02AE3e0a479Fc759c8A28D6ef25',
    18,
    'MASS',
    'MASSIVE',
  ),
...
const tokens = {
  ...
  cake: {
    ...
    decimals: 18,
    projectLink: 'https://Bigswap.finance/',
  },
  wbnb: {
    symbol: 'wBNB',
    address: {
  ...
  big: {
    symbol: '$BIG',
    address: {
      56: '0x0Ec2f25D25193B1Ba62717a035242CfD26D66290',
      96: '',
    },
    decimals: 18,
    projectLink: 'https://www.makerdao.com/',
  ...
  syrup: {
    symbol: 'GAINS',
    address: {
      56: '0x21CB2505481077235c2f59b1b1A546bfc1a0101b',
