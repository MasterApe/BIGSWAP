  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('Big Swap Collectibles')}
      </Heading>
      <Text as="p">
        {t('Big Swap Collectibles are special ERC-721 NFTs that can be used on the Big Swap platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved Big Swap Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved Big Swap Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
